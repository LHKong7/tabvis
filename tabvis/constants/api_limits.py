...
These constants define server-side limits enforced by the model API.
...
Casing: ``tabvis/constants/*`` is exempt from the naming lint — constant names are kept
in UPPER_CASE so call sites read consistently across the codebase.
"""
