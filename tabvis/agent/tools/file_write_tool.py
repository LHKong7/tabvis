...
def get_write_tool_description() -> str:
    ...
    return (
        ...
        "- For a user-requested long research report, create a small outline/source ledger early, "
        "then use Edit after each useful source or bounded section. Do not defer the whole report "
        "to one giant final Write call; that makes cancellation, output limits, and compaction a "
